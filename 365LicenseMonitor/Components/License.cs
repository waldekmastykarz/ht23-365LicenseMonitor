...
namespace _365LicenseMonitor.Components
{
    public class License
    {
        ...
        public bool Visible { get; set; } // Visible can be set on or of

        // Don't set the product name with thte default construction, as we don't know it yet.
        public License(string SkuId, string SkuPartNumber, int? ConsumedUnits, int? PrepaidUnits)
        {
            ...
            try
            {
                var test = GUIDsToProductNames[SkuId];
                ProductName = (string?)GUIDsToProductNames[SkuId];
            }
        ...
        static IDictionary GUIDsToProductNames = new Dictionary<string, string>
        {
            ...
            ["30fc3c36-5a95-4956-ba57-c09c2a600bb9"] = "Azure Active Directory Premium P1 for faculty",
            ...
            ["0c21030a-7e60-4ec7-9a0f-0042e0e0211a"] = "Microsoft 365 E3 (500 seats min) HUB",
            ...
            ["db684ac5-c0e7-4f92-8284-ef9ebde75d33"] = "Microsoft 365 E5 (500 seats min) HUB",
            ...
            ["2113661c-6509-4034-98bb-9c47bd28d63c"] = "Microsoft 365 E5 without Audio Conferencing (500 seats min) HUB",
            ...
            ["440eaaa8-b3e0-484b-a8be-62870b9ba70a"] = "Microsoft Teams Phone Resoure Account",
            ...
            ["989a1621-93bc-4be0-835c-fe30171d6463"] = "Microsoft Teams Premium",
