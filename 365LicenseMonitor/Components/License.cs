...
namespace _365LicenseMonitor.Components
{
    ...
    public class LicenseCategory
    {
        ...
        public LicenseCategory(string CategoryName, bool Visible)
        {
    ...
    public class License
    {
        ...
        Dictionary<string, LicenseProperty> LicenseDictionary = new Dictionary<string, LicenseProperty>()
        {
            ...
            ["4b9405b0-7788-4568-add1-99614e613b69"] = new LicenseProperty("Exchange Online (Plan 1)", "Collaboration and communication"),
            ["aa0f9eb7-eff2-4943-8424-226fb137fcad"] = new LicenseProperty("Exchange Online (Plan 1) for Alumni with Yammer", "Collaboration and communication"),
            ["f37d5ebf-4bf1-4aa2-8fa3-50c51059e983"] = new LicenseProperty("Exchange Online (Plan 1) for GCC", "Collaboration and communication"),
            ["ad2fe44a-915d-4e2b-ade1-6766d50a9d9c"] = new LicenseProperty("Exchange Online (Plan 1) for Students", "Collaboration and communication"),
            ["19ec0d23-8335-4cbd-94ac-6050e30712fa"] = new LicenseProperty("Exchange Online (PLAN 2)", "Collaboration and communication"),
            ["7be8dc28-4da4-4e6d-b9b9-c60f2806df8a"] = new LicenseProperty("Exchange Online (Plan 2) for GCC", "Collaboration and communication"),
            ["ee02fd1b-340e-4a4b-b355-4a514e4c8943"] = new LicenseProperty("Exchange Online Archiving for Exchange Online", "Collaboration and communication"),
            ["90b5e015-709a-4b8b-b08e-3200f994494c"] = new LicenseProperty("Exchange Online Archiving for Exchange Server", "Collaboration and communication"),
            ["e8f81a67-bd96-4074-b108-cf193eb9433b"] = new LicenseProperty("Exchange Online Essentials", "Collaboration and communication"),
            ["7fc0182e-d107-4556-8329-7caaa511197b"] = new LicenseProperty("Exchange Online Essentials (ExO P1 Based)", "Collaboration and communication"),
            ["80b2d799-d2ba-4d2a-8842-fb0d0f3a4b82"] = new LicenseProperty("Exchange Online Kiosk", "Collaboration and communication"),
            ...
            ["0c266dff-15dd-4b49-8397-2bb16070ed52"] = new LicenseProperty("Microsoft 365 Audio Conferencing", "Collaboration and communication"),
            ["2d3091c7-0712-488b-b3d8-6b97bde6a1f5"] = new LicenseProperty("Microsoft 365 Audio Conferencing for GCC", "Collaboration and communication"),
            ["df9561a4-4969-4e6a-8e73-c601b68ec077"] = new LicenseProperty("Microsoft 365 Audio Conferencing Pay-Per-Minute - EA", "Collaboration and communication"),
            ...
            ["16ddbbfc-09ea-4de2-b1d7-312db6112d70"] = new LicenseProperty("Microsoft Teams (Free)", "Collaboration and communication"),
            ["1c27243e-fb4d-42b1-ae8c-fe25c9616588"] = new LicenseProperty("Microsoft Teams Audio Conferencing select dial-out", "Collaboration and communication"),
            ["29a2f828-8f39-4837-b8ff-c957e86abe3c"] = new LicenseProperty("Microsoft Teams Commercial Cloud", "Collaboration and communication"),
            ["fde42873-30b6-436b-b361-21af5a6b84ae"] = new LicenseProperty("Microsoft Teams Essentials", "Collaboration and communication"),
            ["710779e8-3d4a-4c88-adb9-386c958d1fdf"] = new LicenseProperty("Microsoft Teams Exploratory", "Collaboration and communication"),
            ["2cf22bcb-0c9e-4bc6-8daf-7e7654c0f285"] = new LicenseProperty("Microsoft Teams Phone Resource Account for GCC", "Collaboration and communication"),
            ["440eaaa8-b3e0-484b-a8be-62870b9ba70a"] = new LicenseProperty("Microsoft Teams Phone Resoure Account", "Collaboration and communication"),
            ["e43b5b99-8dfb-405f-9987-dc307f34bcbd"] = new LicenseProperty("Microsoft Teams Phone Standard", "Collaboration and communication"),
            ["d01d9287-694b-44f3-bcc5-ada78c8d953e"] = new LicenseProperty("Microsoft Teams Phone Standard for DOD", "Collaboration and communication"),
            ["d979703c-028d-4de5-acbf-7955566b69b9"] = new LicenseProperty("Microsoft Teams Phone Standard for Faculty", "Collaboration and communication"),
            ["a460366a-ade7-4791-b581-9fbff1bdaa85"] = new LicenseProperty("Microsoft Teams Phone Standard for GCC", "Collaboration and communication"),
            ["7035277a-5e49-4abc-a24f-0ec49c501bb5"] = new LicenseProperty("Microsoft Teams Phone Standard for GCCHIGH", "Collaboration and communication"),
            ["aa6791d3-bb09-4bc2-afed-c30c3fe26032"] = new LicenseProperty("Microsoft Teams Phone Standard for Small and Medium Business", "Collaboration and communication"),
            ["1f338bbc-767e-4a1e-a2d4-b73207cc5b93"] = new LicenseProperty("Microsoft Teams Phone Standard for Student", "Collaboration and communication"),
            ["ffaf2d68-1c95-4eb3-9ddd-59b81fba0f61"] = new LicenseProperty("Microsoft Teams Phone Standard for TELSTRA", "Collaboration and communication"),
            ["b0e7de67-e503-4934-b729-53d595ba5cd1"] = new LicenseProperty("Microsoft Teams Phone Standard_System_USGOV_DOD", "Collaboration and communication"),
            ["985fcb26-7b94-475b-b512-89356697be71"] = new LicenseProperty("Microsoft Teams Phone Standard_USGOV_GCCHIGH", "Collaboration and communication"),
            ["989a1621-93bc-4be0-835c-fe30171d6463"] = new LicenseProperty("Microsoft Teams Premium", "Collaboration and communication"),
            ["6af4b3d6-14bb-4a2a-960c-6c902aad34f3"] = new LicenseProperty("Microsoft Teams Rooms Basic", "Collaboration and communication"),
            ["50509a35-f0bd-4c5e-89ac-22f0e16a00f8"] = new LicenseProperty("Microsoft Teams Rooms Basic without Audio Conferencing", "Collaboration and communication"),
            ["4cde982a-ede4-4409-9ae6-b003453c8ea6"] = new LicenseProperty("Microsoft Teams Rooms Pro", "Collaboration and communication"),
            ["21943e3a-2429-4f83-84c1-02735cd49e78"] = new LicenseProperty("Microsoft Teams Rooms Pro without Audio Conferencing", "Collaboration and communication"),
            ["295a8eb0-f78d-45c7-8b5b-1eed5ed02dff"] = new LicenseProperty("Microsoft Teams Shared Devices", "Collaboration and communication"),
            ["b1511558-69bd-4e1b-8270-59ca96dba0f3"] = new LicenseProperty("Microsoft Teams Shared Devices for GCC", "Collaboration and communication"),
            ["74fbf1bb-47c6-4796-9623-77dc7371723b"] = new LicenseProperty("Microsoft Teams Trial", "Collaboration and communication"),
            ...
            ["e6778190-713e-4e4f-9119-8b8238de25df"] = new LicenseProperty("OneDrive for Business (Plan 1)", "Collaboration and communication"),
            ["ed01faf2-1d88-4947-ae91-45ca18703a96"] = new LicenseProperty("OneDrive for Business (Plan 2)", "Collaboration and communication"),
            ...
            ["1fc08a02-8b3d-43b9-831e-f76859e04e1a"] = new LicenseProperty("SharePoint Online (Plan 1)", "Collaboration and communication"),
            ["a9732ec9-17d9-494c-a51c-d6b45b384dcb"] = new LicenseProperty("SharePoint Online (Plan 2)", "Collaboration and communication"),
            ["f61d4aba-134f-44e9-a2a0-f81a5adb26e4"] = new LicenseProperty("SharePoint Syntex", "Add-ons"),
            ["b8b749f8-a4ef-4887-9539-c95b1eaa5db7"] = new LicenseProperty("Skype for Business Online (Plan 1)", "Collaboration and communication"),
            ["d42c793f-6c78-4f43-92ca-e8f6a02b035f"] = new LicenseProperty("Skype for Business Online (Plan 2)", "Collaboration and communication"),
            ["d3b4fe1f-9992-4930-8acb-ca6ec609365e"] = new LicenseProperty("Skype for Business PSTN Domestic and International Calling", "Collaboration and communication"),
            ["0dab259f-bf13-4952-b7f8-7db8f131b28d"] = new LicenseProperty("Skype for Business PSTN Domestic Calling", "Collaboration and communication"),
            ["54a152dc-90de-4996-93d2-bc47e670fc06"] = new LicenseProperty("Skype for Business PSTN Domestic Calling (120 Minutes)", "Collaboration and communication"),
            ["06b48c5f-01d9-4b18-9015-03b52040f51a"] = new LicenseProperty("Skype for Business PSTN Usage Calling Plan", "Collaboration and communication"),
            ["ae2343d1-0999-43f6-ae18-d816516f6e78"] = new LicenseProperty("Teams Phone with Calling Plan", "Collaboration and communication"),
            ["de3312e1-c7b0-46e6-a7c3-a515ff90bc86"] = new LicenseProperty("TELSTRA Calling for O365", "Collaboration and communication"),
